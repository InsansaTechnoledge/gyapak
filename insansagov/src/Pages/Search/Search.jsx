  ...
  const fetchSearch = async () => {
    try {
      ...
      const response = await axios.get(
        `${apiBaseUrl}/api/search/result/${queryData}`
      );
  ...
  return (
    <>
      ...
      <div className="pt-28">
        ...
        {searchData &&
        searchData.authorities.length == 0 &&
        ...
        searchData.organizations.length == 0 ? (
          ...
          <div className="text-2xl xl:text-3xl font-bold text-gray-900 mb-5">
            Your search result for "{query}"
          </div>
        )}
        {searchData &&
        searchData.authorities &&
        searchData.authorities.length > 0 ? (
          <>
        ...
        searchData.authorities.length > 0 ? (
          ...
          <>
            ...
            <MoreOrganizations
              currentOrganization={searchData.organizations[0]}
            />
          </>
        ) : searchData &&
          searchData.categories &&
