...
const BlogDetailPage = lazy(() =>
  import("./Components/BolgPage/components/BlogDetailPage")
);
const CalendarView = lazy(() => import("./Pages/Calendar/CalendarView"));
const CurrentAffairPage = lazy(() =>
  import("./Components/currentAffairs/currentAffairPage")
);
const CurrentAffairDetails = lazy(() =>
  import("./Components/currentAffairs/CurrentAffairDetailPage")
);
const DailyUpdatesReels = lazy(() =>
...
const PageLinks = () => {
  ...
  const shouldHideChatBot =
    isMobile && hideChatBotOn.includes(location.pathname);
