      ...
      >
        ...
        >
          <div className="max-w-3xl mx-auto">
            ...
            {/* Dynamic Tagline */}
            <motion.p
              className="text-lg xs:text-xl capitalize sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-100 mb-8 sm:mb-10 leading-relaxed"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              <p className="text-gray-300 text-sm mb-3">
                Popular searches for government jobs after 12th:
              </p>
