...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={` hidden md:flex bg-white items-center justify-center  h-20 px-6 md:px-36 transition-transform duration-500 top-0 left-0 z-45 w-full fixed
      ...
      >
        ...
        {/* Menu right */}
        <div className="ml-4 flex gap-6 font-medium text-gray-700">
          <a
            href="#about"
              ...
              {visibleCategories.map((category, index) => (
                <div
                  ...
                  onClick={() => {
                    ...
                    setActiveMenu(null);
                    navigate(
                      `/government-organisations-under-category?name=${encodeURI(
                        category.Nameid
                      )}`
                    );
                  }}
