    ...
    return (
        <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl p-6 mb-8 border border-purple-200">
                <h1 className='text-3xl font-bold text-purple-800 text-center mb-2'>Central Organization Event</h1>
                <p className="text-purple-600 text-center">Add central government organization events and opportunities</p>
            </div>
