...
currentAffairSchema.index({ 'affairs.tags': 1 });
currentAffairSchema.index({ 'affairs.category': 1 });

export const CurrentAffair = model('CurrentAffair', currentAffairSchema);
