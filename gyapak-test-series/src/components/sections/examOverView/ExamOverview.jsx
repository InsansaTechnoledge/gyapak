          ...
          <div className="flex border-b">
            <button 
              className={`px-6 py-4 font-medium text-sm flex items-center ${
                activeTab === 'subjects' ? 'text-purple-600 border-b-2 border-purple-600' : 'text-gray-600 hover:text-purple-600'
              }`}
            ...
            <button 
              className={`px-6 py-4 font-medium text-sm flex items-center ${
                activeTab === 'events' ? 'text-purple-600 border-b-2 border-purple-600' : 'text-gray-600 hover:text-purple-600'
              }`}
                                    ...
                                    >
                                      ...
                                      <div 
                                        className={`p-4 flex justify-between items-start cursor-pointer ${
                                          expandedQuestions[question.id] ? 'bg-gray-50' : ''
                                        }`}
                                              ...
                                              return (
                                                <div 
                                                  ...
                                                  className={`p-3 rounded-lg border flex items-start ${
                                                    isCorrect ? 'bg-green-50 border-green-200' : 'bg-white'
                                                  }`}
                                                >
